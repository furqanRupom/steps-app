    ...
    return (
        ...
        <div className="absolute overflow-hidden lg:static lg:shadow-md lg:shadow-gray-800 h-full z-50 lg:z-0 min-h-full ">
            ...
            <div className="flex items-center justify-between bg-gray-900 py-[26px] lg:py-0 ">
                ...
                <button
                    className="lg:hidden text-gray-300 rounded-full px-3"
                            ...
                            <li key={name}>
                                <Link href={path} passHref>
                                    <p className="flex flex-row items-center h-12 transition-transform hover:translate-x-2 ease-in duration-200 text-gray-500 hover:text-red-400">
                                        <span className="inline-flex items-center justify-center h-12 w-full lg:w-12 text-2xl lg:text-lg text-gray-400 hover:text-red-400">
                                            {icon}
                                        </span>
