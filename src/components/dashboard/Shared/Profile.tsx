...
import { FaCamera, FaFacebook, FaInstagram, FaRegEnvelope, FaRegHeart, FaTwitter, FaYoutube } from 'react-icons/fa';
...
const UserProfile: React.FunctionComponent<IUserProfileProps> = ({ profilePhoto, name }) => {
    return (


        <>
           
            <section className="w-full overflow-hidden bg-gradient-to-bl from-slate-900 to-slate-950">
                <div className="flex flex-col">
                    ...
                    <div className="sm:w-[80%] xs:w-[90%] mx-auto flex">
                        <img src={profilePhoto} alt="User Profile"
                            className="rounded-md lg:w-[12rem] lg:h-[12rem] md:w-[10rem] md:h-[10rem] sm:w-[8rem] sm:h-[8rem] xs:w-[7rem] xs:h-[7rem] outline outline-2 outline-offset-2 outline-red-500 relative lg:bottom-[5rem] sm:bottom-[4rem] xs:bottom-[3rem]" />
                            ...
                            <div className="w-full flex sm:flex-row xs:flex-col gap-2 justify-center">
                                <div className="w-full">
                                    <dl className="text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                                        ...
                                        <div className="flex flex-col py-3">
                                            <div className="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Gender</div>
