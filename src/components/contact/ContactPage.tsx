        ...
        <div className="grid lg:grid-cols-3 items-center gap-4 p-2  rounded-lg ">
          ...
          <div className="p-6 rounded-xl lg:col-span-2">
            <div className="text-center py-6 w-full ">
              <h2 className="text-3xl font-extrabold">Contact <span className='text-red-400'>Us</span></h2>
              <p className="text-sm text-gray-600 mt-3">Have some big idea or brand to develop and need help?</p>
            </div>
            <form>
              ...
              <button
                type="button"
                className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded px-4 py-2.5 font-semibold bg-red-500 text-white hover:bg-red-600"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16px"
