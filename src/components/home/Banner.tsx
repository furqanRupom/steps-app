    ...
    return <>
        <div className='min-h-screen  w-full h-full bg-no-repeat bg-cover backdrop-blur-3xl' style={{ backgroundImage: "url(https://w.forfun.com/fetch/3c/3cd2b06c8b9e346a2a0fecfded9e54ce.jpeg)" }}>
            ...
            <div className='w-full mx-auto  pt-12 md:px-12 lg:px-3'>
                <Image className='object-cover hidden md:block rounded-xl shadow border-2 border-t-red-400 border-l-red-400 mx-auto border-r-red-400 border-b-0' width={1000} height={1000} src={largerDeviceImage} alt="banner image one" />
                <Image className='object-cover  md:hidden rounded-xl shadow border-2 border-t-red-400 border-l-red-400 mx-auto border-r-red-400 border-b-0' width={200} height={200} src={smallerDeviceImage} alt="banner image one" />
            </div>
