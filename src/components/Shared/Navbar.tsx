...
const Navbar = () => {
  ...
  return (
    <>
      {
        withoutNavs.includes(pathName) ? <></> : <nav className='flex justify-between items-center px-8 py-3 fixed w-full top-0 z-50  bg-opacity-70 lg:bg-opacity-25 backdrop-blur-2xl bg-slate-900'>
