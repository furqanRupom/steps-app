...
const Footer = () => {
    ...
    return (
        <>
            {
                withoutNavs.includes(pathName) ? <></> : <footer className="text-gray-600 body-font  bg-gradient-to-br from-gray-900 to-gray-950 backdrop-blur-2xl">
                    <div className="container px-10 py-12 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col  ">
                        ...
                        <div className="w-full md:w-1/2 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left mb-6 md:mb-0">
                            ...
                            <div className="flex   mt-4 space-x-4 justify-center lg:justify-start">
                                ...
                                {/* Send button */}
                                <button className="inline-flex text-white bg-red-500 border-0 py-2 px-6 focus:outline-none w-fit  hover:bg-red-600 text-center  rounded-md">Subscribe</button>
                            </div>
                        </div>
                        {/* Navigation Links */}
